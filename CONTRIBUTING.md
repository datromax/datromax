Contributing to Datromax Core
============================

The Datromax Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/datromax/datromax/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Datromax Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Datromax
Network Protocol consensus changes.

Whether a pull request is merged into Datromax Core rests with the project merge
...
Patches that change Datromax consensus rules are considerably more involved than
...
Where a patch set proposes to change the Datromax consensus, it must have been
...
The review process is normally fairly responsive on the Datromax Core repository, however
...
The project leader is the release manager for each Datromax Core release.
