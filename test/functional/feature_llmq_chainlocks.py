...
from test_framework.test_framework import DatromaxTestFramework
...
class LLMQChainLocksTest(DatromaxTestFramework):
    def set_test_params(self):
        self.set_datromax_test_params(6, 5, fast_dip3_enforcement=True)
