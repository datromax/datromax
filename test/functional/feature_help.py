...
"""Verify that starting datromaxd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start datromaxd with -h for help text")
        ...
        self.log.info("Start datromaxd with -version for version information")
