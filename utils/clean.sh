...
rm -f src/config/datromax-config.h
...
rm -rf test_bitcoin.coverage/ datromax-gtest.coverage/ total.coverage/
...
clean_exe src/datromax-cli
clean_exe src/datromaxd
clean_exe src/datromax-gtest
clean_exe src/datromax-tx
clean_exe src/test/test_datromax
clean_exe src/test/test_datromax_fuzzy
...
clean_dep . src/config/datromax-config.h.in
