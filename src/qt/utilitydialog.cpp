    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  datromax-qt [command-line options]                     \n";
...
All the Datromax in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 DTRX, 0.01 DTRX, 0.1 DTRX, 1 DTRX and 10 DTRX -- sort of like the paper money you use every day.</li> \
