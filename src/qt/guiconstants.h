...
/* DatromaxGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* DatromaxGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Datromax"
#define QAPP_ORG_DOMAIN "datromax.com"
#define QAPP_APP_NAME_DEFAULT "Datromax-Qt"
#define QAPP_APP_NAME_TESTNET "Datromax-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Datromax-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Datromax-Qt-regtest"
