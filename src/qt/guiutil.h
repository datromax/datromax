...
/** Utility functions used by the Datromax Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "datromax:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load datromax specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a datromax specific theme is activated (light/dark).*/
