...
#ifndef DATROMAX_ARITH_UINT256_H
#define DATROMAX_ARITH_UINT256_H
...
public:
     ...
     *
     * Datromax only uses this "compact" format for encoding difficulty
...
#endif // DATROMAX_ARITH_UINT256_H
