...
{
    const char* pszTimestamp = "The Times 22/Jan/2018 Datromax is name of the game for new generation of firms";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 2 * 60; // Datromax: 2 minutes
        ...
        vSeeds.emplace_back("seed00.datromax.com");
        vSeeds.emplace_back("seed01.datromax.com");
        vSeeds.emplace_back("seed02.datromax.com");
        vSeeds.emplace_back("seed03.datromax.com");
        vSeeds.emplace_back("seed04.datromax.com");
        vSeeds.emplace_back("seed05.datromax.com");
        vSeeds.emplace_back("seed06.datromax.com");
        vSeeds.emplace_back("ger1.datromax.com");
        vSeeds.emplace_back("ny1.datromax.com");


        // Datromax addresses start with 'r'
...
public:
    CTestNetParams() {
       ...
       // FindMainNetGenesisBlock(1645942755,  0x20001fff, "test");
        ...
        //vSeeds.emplace_back("ger1.datromax.com", true);
        //vSeeds.emplace_back("ny1.datromax.com", true);

        // Testnet Datromax addresses start with 'r'
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("datromaxevo.org",  "devnet-seed.datromaxevo.org"));
