...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("049112eb716a6cafa1695fb03a276b49a1a64e8cb61f2b85ef5cd93d45a9779a653036447e495a4b2f3e1edcb8b297ec4b0fc005526f818ccf31422244f1562e07") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Datromax: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Datromax: 1.5 minutes
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V17].nStartTime = 1728622222; // 1665644400; // 0ct 13, 2022 00:00:00hrs
        ...
        consensus.defaultAssumeValid = uint256S("0x0000084064a6556da63fdb52936c1504154eb0b9765477c238625529dea2dcf7"); // 0
        ...
        genesis = CreateGenesisBlock(1728611111, 927304, 0x1e0ffff0, 4, 5000 * COIN);
        
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc3f1b987f64b3b7b7506a208bd872eed069f65f3c06b40ad5c372090d900bbd2"));
        assert(genesis.hashMerkleRoot == uint256S("0x0bcba2617f626be87902dca445e875697c129bcf1548fb17d96441ab6bf60e91"));

        vSeeds.emplace_back("seed.datromax.com");



        // Datromax addresses start with 'D'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        // Datromax script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Datromax private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Datromax BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Datromax BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Datromax BIP44 coin type is '5'
...
//        	exit(0);
//        }
        std::vector <FounderRewardStructure> rewardStructures = {{INT_MAX, 10}};
        consensus.nFounderPayment = FounderPayment(rewardStructures, 2160);
        ...
        vSporkAddresses = {"DJkdZ3ueH9rjgvKxZiZQg3YhkxgcofTJvj"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
          {  
            { 1, uint256S("0x3a2a3ceb00ee653b9cf50d265b22a99843400f09bfbf59125fca43599f22499b")},
            { 100, uint256S("0x6e89c19e0260e09f0e01c440e7ca1b094b6e6eeb174b152bcc0e9bc80cef3a5d")},
            { 200, uint256S("0x7218b3102b55ca9274949beeb5d5ff0cfff4d181a9dabda009c8cf14dbc7eed9")},
            { 400, uint256S("0x71d0c11f0e52ac1126dcbb9ffed5c6dd27966143b6ce01ab62f413031059612b")},
            { 600, uint256S("0xca62aa8082ed3581c90515d958b533baddf957cfb0432712d5e9ae70def93876")},
            { 700, uint256S("0xa68e393e21f772e61f8a7a127acd1711246632e6dce9b47c1ef80c2c4a95ceb4b")},
            { 1000, uint256S("0x9cb55684fa063876721ba0c04db37f179e3ea6e9fe85d2af435363891f3b4970")},
            { 2000, uint256S("0xccd310715eb9e0e04dcf88536001a88bff0874368ab320875d086e07d1b30ecc")},
            { 3000, uint256S("0x6b3911ced5cca82f754cacc043dd45a22117863e951865d23bfdaeee9ddb801e")},
            { 4000, uint256S("0xe435cb38aeafad45a5a08906753ed0730f50f546b1e0f6b27df67aa80d8ac9aa")},
            { 5000, uint256S("0x158a18a41ec7c3cb28a9104bb11ca49a1d5c974a16eadd6cededda3627ae7ec6")},
            { 6000, uint256S("0x5c22a7f93f27d5f34671a14a29df769e224c1bb6c59737c04665e4d613e744ce")},		
            { 7000, uint256S("0x3838bd52c9870032e67580716a02ab217f7e0d38b04c2d8efab762fa6d4b49d2")},
            { 8000, uint256S("0xe16610a86a36381e5daf06f3dcb2f0dcd6920f69ec06fa8cc669b3d645de1e67")},		
		
          }
        };

        chainTxData = ChainTxData{
            1728611111,   // * UNIX timestamp of last known number of transactions (Block 0)
            8915,   // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Datromax: 1 day
        consensus.nPowTargetSpacing = 60; // Datromax: 1 minutes
        ...
        genesis = CreateGenesisBlock(1728600000, 62536, 0x1e0fffff, 4, 5000 * COIN);
        
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x39e36f50a3d87b73e941d61bd3e336244b321ced6be4d65d321b6b4a932b36fd"));
        assert(genesis.hashMerkleRoot == uint256S("0x0bcba2617f626be87902dca445e875697c129bcf1548fb17d96441ab6bf60e91"));
        ...
        vSeeds.emplace_back("testnet.datromax.com");

        // Testnet Datromax addresses start with 'd'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,90);
        // Testnet Datromax script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Datromax BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Datromax BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Datromax BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "dXht4wFnJ1pKpC54BDEo5YZYkB54ymLo9p");
        ...
        vSporkAddresses = {"dS5NCMv8exQmwqZjpxAZsps9KQRU5eBSbe"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;
        ...
        chainTxData = ChainTxData{
            1728600000, // * UNIX timestamp of last known number of transactions (Block 213054)
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Datromax: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Datromax: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        genesis = CreateGenesisBlock(1728500000, 1096447, 0x207fffff, 1, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("datromax.com",  "devnet-seed.datromaxevo.org"));

        // Testnet Datromax addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Datromax addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Datromax script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Datromax BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Datromax BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Datromax BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
