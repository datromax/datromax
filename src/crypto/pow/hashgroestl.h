...
// Copyright (c) 2018-2023 The Datromax Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
#ifndef DATROMAX_CRYPTO_POW_HASHGROESTL_H
#define DATROMAX_CRYPTO_POW_HASHGROESTL_H
...
#endif // DATROMAX_CRYPTO_POW_HASHGROESTL_H
