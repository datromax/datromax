...
//! Interface for the src/evo part of a datromax node (datromaxd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a datromax node (datromaxd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a datromax node (datromaxd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a datromax node (datromaxd process).
class Node
{
public:
    virtual ~Node() {}
