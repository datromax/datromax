Datromax Core version 0.12.3.4
==========================
...
When deployed on testnet, it is required to start with a fresh data directory or call Datromax Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/datromax/datromax/compare/v0.12.3.3...datromax:v0.12.3.4).
