...
This document provides guidelines for internationalization of the Datromax Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `datromax_en.ts` remains unchanged.
