...
* datromax.conf: contains configuration settings for datromaxd or datromax-qt
* datromaxd.pid: stores the process id of datromaxd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by datromaxd or datromax-qt
