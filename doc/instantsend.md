...
This mechanism has been integrated into Bitcore-Node-Datromax which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/datromax/insight-api-datromax#web-socket-api](https://github.com/datromax/insight-api-datromax#web-socket-api)
* API: [https://github.com/datromax/insight-api-datromax#instantsend-transactions](https://github.com/datromax/insight-api-datromax#instantsend-transactions)
